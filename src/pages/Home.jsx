  ...
  return (
    <DefaultLayout>
      <div className="flex flex-col  w-[1140px] h-screen">
        <div className="py-[120px] mt-[100px] text-6xl text-white font-display font-extrabold">
          <p className="">안녕하세요.</p>
        ...
        <div className="text-[24px] pb-[50px] text-white font-display font-medium">
          드디어<span className="text-prograpy px-[10px]">Prography</span>10기
          모집이 시작되었습니다.
        </div>

        <div className="py-[100px]">
          <div className=" text-[50px] text-white font-display font-extrabold ">
            모집 분야
            <div className="text-[24px] text-[#9FA0AB] font-display font-medium pt-[10px]">
              총 6개의 파트를 모집합니다.
            </div>
          </div>

          <div className=" flex flex-wrap items-center text-white text-[30px] font-display font-extrabold m-[-10px] py-[40px]">
        ...
        <div className="text-[24px] text-[#E1E3ED] font-display py-[20px] font-medium">
        ...
        <div className="flex flex-col  py-[60px] text-center ">
          <div className=" text-6xl text-white font-display font-extrabold py-[20px] pt-[50px]">
        ...
        <div className="flex py-[30px] items-center justify-center">
          <button className="w-[300px] h-[100px] bg-prograpy rounded-full">
            <div className=" text-[30px] text-white  font-display font-extrabold">
              지원하기
            </div>
          </button>
        </div>
